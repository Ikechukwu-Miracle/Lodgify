#!/usr/bin/python3
""" This defines unittests for models/city.py.
Unittest classes:
...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Test that a new City instance can be created with no arguments."""
    ...
    def test_id_is_public_str(self):
        """Test that the id attribute of a new City instance is a public string."""
    ...
    def test_state_id_is_public_class_attribute(self):
        """Test that the state_id attribute is a public class attribute."""
        cy = City()
    ...
    def test_two_cities_different_created_at(self):
        """Test that the created_at attributes of two City instances are different."""
        cy1 = City()
        sleep(0.05)
        cy2 = City()
    ...
    def test_two_cities_different_updated_at(self):
        """Test that the updated_at attributes of two City instances are different."""
        cy1 = City()
        sleep(0.05)
        cy2 = City()
